...
if [ "$color_prompt" = yes ]; then
    # Set a colorful and stylish prompt
    # PS1='\[\033[01;32m\]┌──${debian_chroot:+($debian_chroot)}(\[\033[00m\]\u\[\033[01;32m\])-[\[\033[01;34m\]\w\[\033[01;32m\]]\n└─\[\033[00m\]\$ '
    PS1='\[\033[38;5;166m\]\u\[\033[0m\]@\[\033[38;5;99m\]\h\[\033[0m\]:\[\033[38;5;228m\]\w\[\033[0m\]\$ '
else
...
ow=1;34:\
st=1;34:\
*.tar=1;31:*.tgz=1;31:*.zip=1;31:*.gz=1;31:*.sh=1;32:*.c=1;36:*.cpp=1;36:*.h=1;36:*.out=1;32:*.py=1;35:*.log=0;33"

# Safe fallback alias setup
